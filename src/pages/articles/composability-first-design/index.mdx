...
export const meta = {
  ...
  description: 'Also known as Atomic-First Design, read along for an explanation and to learn more about how these programming design principles can improve your development experience (DX).',
}
