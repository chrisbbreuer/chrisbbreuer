      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m Chris, a software engineer, educator and entrepreneur based in Playa Vista, CA—also known as Silicon Beach. Founding member of the <em>Open Web Foundation</em>, and founder of <em>Stacks.js</em>, <em>Meema</em> & <em>CION Agency</em>.
          </p>
